        ...
        <div class="inputBlock1">
            ...
            <form action="AccountsStructureServlet">                
                ...
                <input type="text" class="inputTextBox" value="" size="30" 
                       name="inputName" placeholder="Account Name" 
                       maxlength="255"/>
                <input type="text" class="inputTextBox" value="" size="20" 
                       name="inputCurrentRemainder" 
                       placeholder="Current Remainder, cur"/>
                                ...
                                <c:choose>
                                    <c:when test="${row.ID == requestScope
                                        ...
                                        <td><input type="text" 
                                                   class="inputTextBox" 
                                                   value="${row.NAME}" 
                                                   size="30" name="updateName" 
                                                   placeholder="..." 
                                                   maxlength="255"/>
                                        </td>
                                        <td><input type="text" 
                                                   class="inputTextBox" 
                                                   value="${row.CURRENT_REMAINDER_CUR}" 
                                                   size="15" 
                                                   name="updateCurrentRemainder" 
                                                   placeholder="..."/>
                                        </td>
                                        <td><input type="submit" 
                                                   class="button" value="Submit" 
                                                   name="submitUpdate_${row.ID}"/>
                                        </td>
                                        <td><input type="submit" 
                                                   class="button" 
                                                   value="Cancel" 
                                    ...
                                    <c:otherwise>
                                        ...
                                        <td> 
                                            <c:out value = "${row.CURRENT_REMAINDER_CUR}"/>
                                        </td>                        
                                        <td><input type="submit" 
                                                   class="button" 
                                                   value="Update" 
